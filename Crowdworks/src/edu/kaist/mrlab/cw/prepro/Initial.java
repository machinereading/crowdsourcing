...
public class Initial {
	...
	public static void main(String[] ar) throws Exception {
		...
		br = Files.newBufferedReader(Paths.get("data/target/target_first_paragraph_list_from_re.txt"));
		input = null;
		while ((input = br.readLine()) != null) {
			StringTokenizer st = new StringTokenizer(input, "\t");
...
//					System.out.println(docID + "\t" + parID);
					...
					StringTokenizer stp = new StringTokenizer(plainText, " ");
					int tokenLength = stp.countTokens();
					...
					bw = Files.newBufferedWriter(Paths.get("data/annotated/wiki-10000-part2/task1/input_190129/",
							docID + "_" + parID + ".json"));
